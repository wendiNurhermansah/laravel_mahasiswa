 ...
 <div class="container">
            <div class="row">
                <div class="col-8">
                    ...
                    <form method="post" action="{{ url('/mahasiswa') }}/{{ $students->id }}/{{ ('update') }}">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nim" placeholder="masukan nim" name="nim" value="{{ $students->nim }}">
                        </div>
                        <div class="form-group">
                            <label for=alamat>Alamat</label>
                            <input type="textarea" class="form-control" id="alamat" placeholder="masukan alamat" name="alamat" value="{{ $students->alamat }}">
                        </div>
                        <div class="form-group">
                             <label>Jurusan</label>
                                 <div>
                                  <select class="select2 form-control" name="id_jurusan" id="id_jurusan" autocomplete="off">
                                   ...
                                   <option value="">Pilih</option>
                                     ...
                                     <option value="{{ $students->id_jurusan }}">{{ $i->n_jurusan }}</option>
                                    @endforeach
                                      </select>
                         ...
                         <div class="form-group">
                          ...
                          <div>
                             <button type="submit" class="btn btn-primary btn-sm" id="action"><i class="icon-save mr-2"></i>Ubah<span id="txtAction"></span></button>
